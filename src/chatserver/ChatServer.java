...
public class ChatServer {
    ...
    // Recibe el error de que no te puedes conectar a un servidor por exceso de conexiones
    public void errorOverloadServer(String host, int port) {
        this.gui.errorOverloadServer(host, port);
    }

    // Recibe el error de puerto en uso
    ...
    //Envía mensajes solo a clientes (excepto al que lo envía)
    ...
    //Envia mensajes solo a servidores (excepto al que lo envía)
    ...
    // Añade estadisticas de mensajes enviados a servidores
    ...
    // Sincroniza estadísticas de servidores al conectarse
